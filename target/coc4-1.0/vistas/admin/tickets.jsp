<%-- 
    Document   : tickets
    Created on : 13 ene. 2024, 20:56:48
    Author     : Cristian
--%>
        ...
        <nav class="navbar navbar-expand-lg  bg-dark border-bottom border-body sticky-top"   data-bs-theme="dark">
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse d-flex justify-content-between" id="navbarNav">
                    <ul class="navbar-nav">
                        <li class="nav-item">
                            <a class="nav-link " aria-current="page" href="oradores.jsp?page=1">Oradores</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link active fw-bold" href="#">Tickets</a>
                        </li>
                    </ul>
                    <div>
        ...
        <section class="container">
            <div class="row row-cols-1 gap-5 my-5">
                <div class="col text-center">
                    <h1 class="fs-2 fw-bold">Listas de Ventas de Ticket</h1>
                </div>
                <div class="col my-lg-5 d-flex flex-column justify-content-center">
                    <table class="table border-1 border-dark shadow-lg">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="btn" href="editTicket.jsp?id=<%= ticket.getId()%>">
                                    ...
                                    <a class="btn" href="../../controlador?ticket=<%= ticket.getId()%>" >
                    ...
                    <nav aria-label="Page navigation example" class="align-self-end">
                        <ul class="pagination">
                            <li class="page-item">
                                <a class="page-link"  href="tickets.jsp?page=<%= pagination - 1%>"  aria-label="Previous">
                                    <span aria-hidden="true">&laquo;</span>
                                    <span class="sr-only">Previous</span>
                                </a>
                            </li>
                            <li class="page-item"><a class="page-link disable" href="#"><%= pagination%>  </a></li>
                            <a class="page-link"  href="tickets.jsp?page=<%= pagination + 1%>" aria-label="Next">
